...
|---|---|---:|---:|---|---|---|---|---|
| RISK-ANALOG-01 | USB, digital, or RF noise corrupts the bridge measurement | High | High | Unstable or biased counts that appear plausible | Compare ADCs; datasheet-based supply/filtering; short paired bridge wiring; ground/return strategy; RF-condition measurements; stability/uncertainty gate | Datasheet review #2; NOISE-01; schematic/ERC #3; PCB/EMC/DRC #6 | Hardware/measurement (#2/#3/#4/#6) | Open; no selected ADC or measurements |
| RISK-RF-01 | Antenna is blocked by copper, cell metal, fasteners, or enclosure | Medium | Medium | Poor provisioning/reconnect, sampling interactions | Manufacturer antenna keepout; prototype clearance; enforceable all-layer/component/mechanical rule areas; avoid analog routing near antenna | Manufacturer guidance #2; layout audits #6; WIFI-01 and NOISE-01 | Hardware/mechanical (#2/#6) | Open; geometry not selected |
| RISK-MECH-01 | Overload/off-center force damages cell or routes load through PCB/connectors | Medium | High | Damage, sudden shift, misleading calibration, possible falling bin | Separate base/cell/top-plate load path; rated-load derating; rigid mounts; non-slip feet; adjustable stops; strain relief; prohibit unsupported loading | Datasheet/fixture review #2; CAD/DRC #6; OFFCENTER-01/OVR-01; post-test zero/span | Mechanical (#2/#6/#7) | Open; no fixture or load evidence |
...
| RISK-SOURCE-01 | Prototype candidate is retired, unavailable, wrong revision, or unsuitable for carrier | High | Medium | Unbuildable design or invalid pin/application assumptions | Exact Manufacturer/MPN/SKU; manufacturer datasheets; lifecycle/stock timestamp; compare HX711 and NAU7802 class; schematic properties as BOM source; second-source analysis | Selection record #2; BOM/datasheet audit #3/#7 | Hardware/BOM (#2/#3/#7) | Open; preliminary BOM contains TBD/retired candidate |
